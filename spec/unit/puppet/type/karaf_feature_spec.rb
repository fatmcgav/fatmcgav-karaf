...
describe Puppet::Type.type(:karaf_feature) do
  ...
  let :providerclass do
    described_class.provide(:fake_karaf_feature_provider) { mk_resource_methods }
  end
  ...
  describe "when validating values" do
    describe "for name" do
      ...
      it "should not support spaces" do
        expect { described_class.new(:name => 'feature name', :ensure => :present) }.to raise_error(Puppet::Error, /feature name is not a valid feature name/)
      end
    end
